...
"use strict";
    ...
    export  const CANVAS_WIDTH: number =468;
    export  const CANVAS_HEIGHT: number =60;
    let stage: createjs.Stage; 
    //let  adLabel = new objects.LabelAd("Mamun","20px Arial","#ffffff", CANVAS_WIDTH * 0.3,CANVAS_HEIGHT * 0.5,true);
  //  let adButton = objects.ButtonAd;
var helloLabel:objects.Label;
 ...
 stage.update();
    ...
    function main(): void{
       // adLabel = new objects.ButtonAd("Solution","20px Consolas",
       // "#EEE888",CANVAS_WIDTH * 0.30, CANVAS_HEIGHT * 0.7,true);

    //   stage.addChild(adLabel);
                helloLabel = new objects.Label("MAMUN", "40px Consolas","#ffffff", 160, 160, true);
